    ...
    public class RoslynCompilationService : ICompilationService
    {
        ...
        public Templates.CompilationResult Compile(string content)
        {
            ...
            if (result.Success)
            {
                ...
                return Templates.CompilationResult.Successful(string.Empty, type);
            }
            else
            {
                return Templates.CompilationResult.Failed(content, result.ErrorMessages);
            }
        }
        ...
        private List<MetadataReference> GetApplicationReferences()
        {
            ...
            foreach (var baseProject in baseProjects)
            {
                ...
                if (exports != null)
                {
                    foreach (var metadataReference in exports.SelectMany(exp => ResolvedReferenceExtensions.GetMetadataReference(exp,throwOnError: false)))
                    {
